...
func (m *mockChunkStore) ModelChanged(_, _ string, _ int, _ string, _ int) (domain.ModelChange, error) {
	return domain.ModelChange{}, nil
}
func (m *mockChunkStore) UpdateMeta(_, _ string, _ int, _ string, _ int) error { return nil }
